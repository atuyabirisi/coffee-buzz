...
export default function Navigation() {
  ...
  return (
    <div className="flex flex-col md:flex-row flex-wrap bg-[#f5e9df]">
      <div className="flex justify-center basis-full md:basis-3/12 p-2">
      ...
      <div className="hidden md:flex md:basis-6/12 p-2 items-center justify-center">
        <ul className="flex gap-6">
          {["About", "Shop", "Blog"].map((item) => (
            <li
              key={item}
              className="text-black text-xl font-semibold hover:text-stone-500 cursor-pointer"
            >
              {item}
            </li>
          ))}
